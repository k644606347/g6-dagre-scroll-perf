...
var Canvas = /** @class */ (function (_super) {
    ...
    Canvas.prototype.getPixelRatio = function () {
        var pixelRatio = this.get('pixelRatio') || (0, util_1.getPixelRatio)();
        // 不足 1 的取 1，超出 1 的取整
    ...
    Canvas.prototype.getShape = function (x, y) {
        ...
        if (this.get('quickHit')) {
            shape = (0, hit_1.getShape)(this, x, y);
        }
        else {
    ...
    Canvas.prototype._getRefreshRegion = function () {
        ...
        if (elements.length && elements[0] === this) {
            ...
            region = (0, draw_1.getMergedRegion)(elements);
            if (region) {
                ...
                // 自动裁剪不在 view 内的区域
                if (clipView) {
                    region = (0, draw_1.mergeView)(region, viewRegion);
                }
            }
        }
        return region;
    ...
    Canvas.prototype._clearFrame = function () {
        ...
        if (drawFrame) {
            ...
            (0, util_1.clearAnimationFrame)(drawFrame);
    ...
    Canvas.prototype._drawAll = function () {
        ...
        context.clearRect(0, 0, element.width, element.height);
        (0, draw_1.applyAttrsToContext)(context, this);
        (0, draw_1.drawChildren)(context, children);
    ...
    Canvas.prototype._drawRegion = function () {
        ...
        if (region) {
            ...
            (0, draw_1.checkRefresh)(this, children, region);
            // 绘制子元素
            (0, draw_1.drawChildren)(context, children, region);
            context.restore();
        }
            ...
            (0, draw_1.clearChanged)(refreshElements);
        }
        (0, util_1.each)(refreshElements, function (element) {
    ...
    Canvas.prototype._startDraw = function () {
        ...
        var drawFrame = this.get('drawFrame');
        if (!drawFrame) {
            drawFrame = (0, util_1.requestAnimationFrame)(function () {
