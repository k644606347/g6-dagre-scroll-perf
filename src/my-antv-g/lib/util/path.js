...
function isPointInStroke(segments, lineWidth, x, y, length) {
    ...
    for (var i = 0; i < segments.length; i++) {
        ...
        if (box && !(0, util_1.inBox)(box.x - halfWidth, box.y - halfWidth, box.width + lineWidth, box.height + lineWidth, x, y)) {
            continue;
        }
        switch (segment.command) {
            ...
            case 'L':
            case 'Z':
                isHit = (0, line_1.default)(prePoint[0], prePoint[1], currentPoint[0], currentPoint[1], lineWidth, x, y);
                break;
            case 'Q':
            ...
            case 'A':
                ...
                isHit = (0, arc_1.default)(0, 0, r, startAngle, endAngle, lineWidth, p[0], p[1]);
                break;
            default:
                break;
        }
