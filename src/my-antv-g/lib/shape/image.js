...
function isCanvas(dom) {
    return dom instanceof HTMLElement && (0, util_1.isString)(dom.nodeName) && dom.nodeName.toUpperCase() === 'CANVAS';
}
var ImageShape = /** @class */ (function (_super) {
    ...
    ImageShape.prototype.createPath = function (context) {
        ...
        if (img instanceof Image || isCanvas(img)) {
            if (!(0, util_1.isNil)(sx) && !(0, util_1.isNil)(sy) && !(0, util_1.isNil)(swidth) && !(0, util_1.isNil)(sheight)) {
