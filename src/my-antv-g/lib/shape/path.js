...
function isInPolygons(polygons, x, y) {
    ...
    for (var i = 0; i < polygons.length; i++) {
        ...
        isHit = (0, polygon_1.default)(points, x, y);
        if (isHit) {
            break;
        }
    }
...
var Path = /** @class */ (function (_super) {
    ...
    Path.prototype._setPathArr = function (path) {
        // 转换 path 的格式
        this.attrs.path = (0, path_util_1.path2Absolute)(path);
    ...
    Path.prototype.getSegments = function () {
        ...
        if (!segments) {
            segments = (0, path_util_1.path2Segments)(this.attr('path'));
    ...
    Path.prototype.createPath = function (context) {
        ...
        (0, draw_1.drawPath)(this, context, attrs, paramsCache);
    };
    ...
    Path.prototype.getPoint = function (ratio) {
        ...
        (0, util_1.each)(tCache, function (v, i) {
        ...
        var seg = curve[index];
        if ((0, util_1.isNil)(seg) || (0, util_1.isNil)(index)) {
            return null;
        }
        var l = seg.length;
    ...
    Path.prototype._setTcache = function () {
        ...
        (0, util_1.each)(curve, function (segment, i) {
            segmentN = curve[i + 1];
            l = segment.length;
            if (segmentN) {
                totalLength +=
