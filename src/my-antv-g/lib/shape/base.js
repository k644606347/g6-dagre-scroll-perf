...
var ShapeBase = /** @class */ (function (_super) {
    ...
    ShapeBase.prototype.onCanvasChange = function (changeType) {
        (0, draw_1.refreshElement)(this, changeType);
    };
    ShapeBase.prototype.calculateBBox = function () {
        var type = this.get('type');
        var lineWidth = this.getHitLineWidth();
        // const attrs = this.attr();
        var bboxMethod = (0, g_base_2.getBBoxMethod)(type);
    ...
    ShapeBase.prototype._applyClip = function (context, clip) {
        if (clip) {
            ...
            (0, draw_1.applyAttrsToContext)(context, clip);
            // 绘制 clip 路径
    ...
    ShapeBase.prototype.draw = function (context, region) {
        ...
        if (region) {
            ...
            if (!(0, util_1.intersectRect)(region, bbox)) {
    ...
    ShapeBase.prototype.cacheCanvasBBox = function () {
        ...
        if (canvasBBox) {
            var bbox = this.getCanvasBBox();
            var isInView = (0, util_1.intersectRect)(bbox, canvasBBox);
    ...
    ShapeBase.prototype.strokeAndFill = function (context) {
        ...
        if (this.isFill()) {
            if (!(0, util_1.isNil)(fillOpacity) && fillOpacity !== 1) {
        ...
        if (this.isStroke()) {
            if (lineWidth > 0) {
                if (!(0, util_1.isNil)(strokeOpacity) && strokeOpacity !== 1) {
