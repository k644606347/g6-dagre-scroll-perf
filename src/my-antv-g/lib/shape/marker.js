...
var Marker = /** @class */ (function (_super) {
    ...
    Marker.prototype._getR = function (attrs) {
        ...
        return (0, util_1.isNil)(attrs.r) ? attrs.radius : attrs.r;
    };
    Marker.prototype._getPath = function () {
        ...
        var method;
        var path;
        if ((0, util_2.isFunction)(symbol)) {
            method = symbol;
            path = method(x, y, r);
            // 将 path 转成绝对路径
            path = (0, path_util_1.path2Absolute)(path);
        }
        else {
            // 内置 symbol 的 path 都是绝对路径，直接绘制即可，不需要对 path 进行特殊处理
            method = Marker.Symbols[symbol];
            if (!method) {
                console.warn("".concat(symbol, " marker is not supported."));
                return null;
            }
            path = method(x, y, r);
        }
    ...
    Marker.prototype.createPath = function (context) {
        ...
        (0, draw_1.drawPath)(this, context, { path: path }, paramsCache);
    };
